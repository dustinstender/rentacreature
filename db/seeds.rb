...
file = URI.open('https://api.cloudinary.com/v1_1/creaturespic/image/upload')

# power = ['good-luck', 'flying', 'dark-power', 'magic']
# creature = Creature.create!([{ name: "Marly",
#                     species: "elf",
#                     age: 300,
...
#                     price_per_day: 28,
#                     user: owner }])
creature.each { |pic| pic.profile_pic.attach(io: file, filename: 'creature.png', content_type: 'image/png') }
